...
func _init() -> void:
	...
	_add_node("unlock_space_station", "Orbital Facilities", "Launches basic structural components into Low Orbit.", 300.0, Vector2(0, -160), ["root"], 2, "Unlocks Space Station District", 1)
	_add_node("unlock_orbital_shipyard", "Orbital Shipyard", "Constructs huge orbital vessels to boost local logistics.", 1000.0, Vector2(160, -160), ["unlock_space_station"], 3, "Unlocks Orbital Shipyard", 1)
	...
	_add_node("unlock_cryo_vault", "Cryo-Vault Architecture", "Blueprints for massive underground cryo-vaults.", 4000.0, Vector2(-480, -800), ["colonize_ice"], 6, "Unlocks Cryo-Vault", 1)
	...
	_add_node("unlock_solar_matrix", "Solar Matrix", "Blueprints for colossal solar arrays.", 4000.0, Vector2(-160, -800), ["colonize_desert"], 6, "Unlocks Solar Matrix", 1)
	...
	_add_node("unlock_atmospheric_siphon", "Atmospheric Siphon", "Blueprints for massive gas siphons.", 4000.0, Vector2(160, -800), ["colonize_gas"], 6, "Unlocks Atmospheric Siphon", 1)
	...
	_add_node("unlock_geothermal_plant", "Geothermal Plant", "Blueprints for extreme geothermal energy extraction.", 4000.0, Vector2(480, -800), ["colonize_volcanic"], 6, "Unlocks Geothermal Plant", 1)
	...
	_add_node("unlock_advanced_lab", "Advanced Research", "Upgrades the basic University into a dedicated high-yield Research Lab.", 150.0, Vector2(-120, 240), ["root"], 2, "Unlocks Advanced Lab", 1)
	_add_node("unlock_research_academy", "Research Academy", "Large-scale science academy to generate passive Science.", 800.0, Vector2(-240, 480), ["unlock_advanced_lab"], 3, "Unlocks Research Academy", 1)

	# --- BRANCH 3: MINING (Left-Down) ---
	_add_node("unlock_deep_drill", "Deep Drill", "Unlocks high-yield Deep Drills to penetrate bedrock.", 200.0, Vector2(-240, 160), ["root"], 2, "Unlocks Deep Drill", 1)
	...
	_add_node("unlock_refinery", "Refinery", "Unlocks ore-to-mineral Refineries.", 400.0, Vector2(-480, 320), ["unlock_deep_drill"], 3, "Unlocks Refinery", 1)
	...
	_add_node("unlock_commercial", "Commercial Hubs", "Transitions from simple trade to high-density commercial centers.", 150.0, Vector2(0, 320), ["root"], 2, "Unlocks Commercial Center", 1)
	_add_node("unlock_luxury_complex", "Luxury Complex", "Unlocks premium housing for elites.", 600.0, Vector2(0, 640), ["unlock_commercial"], 3, "Unlocks Luxury Complex", 1)
